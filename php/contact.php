...
$to = "test@brandifystudio.com"; // <--- Your email ID here

$server_email = 'webmaster@brandifystudio.com'; // Your server email to authenticate outgoing emails. eg: name@yourdomain.com
